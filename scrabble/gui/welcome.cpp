...
// EM ĐỪNG ĐỂ LOGIC GUI Ở TRONG HÀM MAIN KIỂU NHƯ NÀY, VÌ KHI LINK WELCOME.CPP VÀO TARGET CHÍNH THÌ NÓ SẼ BÁO LÀ CÓ 2 HÀM MAIN ĐƯỢC ĐỊNH NGHĨA (Ở TRONG MAIN.CPP VÀ TRONG FILE NÀY). CÁCH TỐT NHẤT LÀ ĐƯA LOGIC CỦA GUI VÀO 1 CLASS KIỂU NHƯ 'GUI'
// ===== MAIN =====
// int main() {
//     // Initialize SDL
